...
async function Side() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 sm:py-12 md:py-16 lg:py-20">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4">Upgrade Your Living Room</h2>
      <p className="text-[#737272] text-sm sm:text-base font-semibold text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20 max-w-2xl mx-auto">
