      ...
      <div className="container mx-auto flex justify-between items-center">
       ...
       <div></div>
        ...
        <div className="hidden xl:flex items-center space-x-[50px]">
          <Link href="/account"><User size={26} className="hover:text-gray-600 stroke-2" /></Link>
          <Link href=""><Search size={26} className="hover:text-gray-600 stroke-2" /></Link>
          <Link href="/cart"><Heart size={26} className="hover:text-gray-600 stroke-2" /></Link>
          <Link href="/cart"><ShoppingCart size={26} className="hover:text-gray-600 stroke-2" /></Link>
          <UserButton />
        </div>
